...
@Component({
  selector: 'app-extensionesangular',
  templateUrl: './extensionesangular.component.html',
  styleUrls: ['./extensionesangular.component.css']
})
export class ExtensionesangularComponent implements OnInit {
