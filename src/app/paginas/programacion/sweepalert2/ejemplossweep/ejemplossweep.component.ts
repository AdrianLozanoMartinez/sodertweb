...
@Component({
  selector: 'app-ejemplossweep',
  templateUrl: './ejemplossweep.component.html',
  styleUrls: ['./ejemplossweep.component.css']
})
export class EjemplossweepComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
  }
//Para poder ver en el html código que no se puede poner directamente en él
c=`{`;
