...
@Component({
  selector: 'app-configuracionsweep',
  templateUrl: './configuracionsweep.component.html',
  styleUrls: ['./configuracionsweep.component.css']
})
export class ConfiguracionsweepComponent implements OnInit {
