...
@Component({
  selector: 'app-forfirevarioselementoshtml4',
  templateUrl: './forfirevarioselementoshtml4.component.html',
  styleUrls: ['./forfirevarioselementoshtml4.component.css']
})
export class Forfirevarioselementoshtml4Component implements OnInit {

  unomodel2: UnoModel[] = [];        

  variablecargando = false;  

  constructor( private variableservicio: ServicioformulariofireService ) { }

  ngOnInit() {  

  /*Antes que cualquier cosa se dispare esto por eso lo ponemos el 1º dentro del ngOnInit
    Dentro del ngOnInit para que se dispare el 1º, en true para que aparezca cargando 
    mientras carga los datos/página*/
